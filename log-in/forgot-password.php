...
<head>
    ...
    <title>HAKR-M - Forgot Password</title>
        ...
        <div class="fxt-content">
            <div class="fxt-header">
                ...
                <ul class="fxt-switcher-wrap">
                    <li><a href="login.php" class="switcher-text">Login</a></li>
                    <li><a href="forgot-password.php" class="switcher-text active">Forgot Password</a></li>
                </ul>
            </div>                            
            <div class="fxt-form"> 
