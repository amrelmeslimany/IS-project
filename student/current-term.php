        ...
        <div class="col-md-9">
          <div class="container-fluid">
            ...
            <div class="buttons mb-4 clearfix">
              <button class="btn print-table"><i class="fas fa-print mr-2"></i><span>Print</span></button><a class="btn history-pg float-right" href="history.php"><i class="fas fa-history mr-2"></i><span>History</span></a>
            </div>
          </div>
        </div>
        <div class="col-md-3">
