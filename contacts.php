        ...
        <div id="main">
            ...
            <div class="content full-height no-mob-hidden2" data-pagetitle="Contacts">
                  ...
                  <div class="content-front">
                     <div class="cf-inner">
                        ...
                        <div class="contact-details fl-wrap">
                           <ul>
                              <li><span>01. Mail :</span><a href="#" target="_blank">hakrm@gmail.com</a></li>
                              <li><span>02. Adress :</span><a href="#" target="_blank">ElBehara-Elnubaria Damnhour university</a></li>
                              <li><span>03. Phone :</span><a href="#">+201128120374</a></li>
                           </ul>
                        </div>
                  ...
                  <div class="content-back">
                     <div class="hidden-contact_form-wrap_inner">
                        ...
                        <div id="contact-form" class="fl-wrap">
                           <div id="message"></div>
                           <form  class="custom-form" action="hakrm" name="contactform" id="contactform">
                              <fieldset>
                                 <div class="row">
                                    <div class="col-sm-6">
               ...
               <div class="map-container">
                  <div id="map-single" class="map" data-latlog="[31.2287199 , 29.9468264]" data-popuptext="My Location in Alexandria ."></div>
               </div>
