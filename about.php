...
<html lang="en">
    ...
    <body>
        <div class="loader">
            <div class="loading-text-container "><span class="loading-text">HAKR<strong>&nbsp;&nbsp;&nbsp;M</strong></span> <span class="loader_count">0</span></div>
            ...
            <div id="wrapper">
                <div class="nav-holder">
                    <div class="nav-holder-wrap but-hol">
                        ...
                        <div class="nav-footer"><span>&#169; HAKRM 2020  /  All rights reserved. </span></div>
                        <div class="nav-holder-wrap_line"></div>
                        <div class="nav-holder-wrap_dec"></div>
                    </div>
                </div>
                <div class="nav-overlay"></div> 
                <div class="content"  data-pagetitle="about HAKR-M">
                    <div class="page-scroll-nav">
                        <nav class="scroll-init page-scroll-nav_wrap">
                            <ul class="no-list-style init_hidden_filter">
                                ...
                                <li><a class="scroll-link fbgs" href="#sec2" data-bgtext="02"><span>Project</span></a></li>
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="ms-item_fs fl-wrap">
                                                    <div class="bg par-elem"  data-bg="images/Back/1.jpg"  ></div>
                                                </div>
                                            </div>
                                            <div class="swiper-slide ">
                                                <div class="ms-item_fs fl-wrap">
                                                    <div class="bg par-elem"  data-bg="images/Back/2.jpg"></div>
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="ms-item_fs fl-wrap">
                                                    <div class="bg par-elem"  data-bg="images/Back/3.jpg"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <section class="scroll_sec" id="sec1">
                                <div class="container">
                                    <div class="section-title">
                                        <h3>Some   Words About HAKR-M  </h3>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas in pulvinar neque. Nulla finibus lobortis pulvinar.  </p>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-5">
                                            <div class="dec-img   fl-wrap">
                                                <img src="images/Back/1.jpg" class="respimg" alt="">
                                                <a class="video_link image-popup" href="https://youtu.be/vxvva4Rbt2M"><i class="fas fa-play"></i><span>Play Our video</span></a>
                                            </div>
                                        </div>
                                        <div class="col-sm-7">
                                                ...
                                                <div class="swiper-wrapper">
                                                    <div class="swiper-slide">
                                                        <div class="team-box">
                                                            <div class="team-photo">
                                                                <div class="overlay"></div>
                                                                <img src="images/team/karem.jpeg" alt="" class="respimg"> 	
                                                    ...
                                                    <div class="swiper-slide">
                                                        <div class="team-box">
                                                            <div class="team-photo">
                                                                <div class="overlay"></div>
                                                                <img style="height: 380px;" src="images/team/logomain.png" alt="" class="respimg"> 
                                                                <a href="#" class="team-contact_btn color-bg"><i class="fal fa-envelope"></i></a>
                                                    ...
                                                    <div class="swiper-slide">
                                                        <div class="team-box">
                                                            <div class="team-photo">
                                                                <div class="overlay"></div>
                                                                <img style="height: 380px;" src="images/team/amr.jpeg" alt="" class="respimg"> 	
                                                                <a href="#" class="team-contact_btn color-bg"><i class="fal fa-envelope"></i></a>
                                                            ...
                                                            <div class="team-info">
                                                                <h3>Amr ElMeslmany</h3>
                                                                <h4>Developer / Front End Developer</h4>
                                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.  </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="swiper-slide">
                                                        <div class="team-box">
                                                            <div class="team-photo">
                                                                <div class="overlay"></div>
                                                                <img src="images/team/eid.jpeg" alt="" class="respimg"> 	
                                                                <a href="#" class="team-contact_btn color-bg"><i class="fal fa-envelope"></i></a>
                                                                <div class="team-info-num">03.</div>
                                                                <ul class="team-social">
                                                                    <li><a href="#" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
                                                            ...
                                                            <div class="team-info">
                                                                <h3>Ahmed Eid</h3>
                                                                <h4>Developer / Back End Developer</h4>
                                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.  </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-9">
                                            <div class="skillbar-box animaper">
                                                ...
                                                <div class="custom-skillbar-title"><span>Bootstrap</span></div>
                                                <div class="skill-bar-percent">15%</div>
                                                <div class="skillbar-bg" data-percent="15%">
                                                    <div class="custom-skillbar"></div>
                                                </div>
